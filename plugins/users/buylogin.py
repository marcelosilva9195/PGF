...
@Client.on_callback_query(filters.regex(r"^comprar_login$"))
async def comprar_logins_list(c: Client, m: CallbackQuery):
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                ...
                InlineKeyboardButton("Como usar", url="https://t.me/afxsearch/119"),
            ],
            [
    ...
    await m.edit_message_text(
        f"""<a href=''>&#8204</a><b>🎟 Menu de compras</b>
<i>- Escolha qual opção deseja abaixo. Cada categoria tem sua descrição!!</i>
